...
REGISTRY = Registry([
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x1676FA6,  index=3,   request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[3]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xDACF21B,  index=49,  request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[4]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x1348AB07, index=71,  request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[4]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x23E55DA0, index=125, request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[5]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x34A164E7, index=173, request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[0]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x40FF01B7, index=222, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[6]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x501A162D, index=280, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[5]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x62D645D9, index=340, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[5]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x649B10DA, index=347, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[0]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x69B8FF28, index=371, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[2]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x71CB0B57, index=406, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[1]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x74FD4609, index=415, request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[2]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x8EF6FBBD, index=509, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[1]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0x993C06F6, index=559, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[3]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xC8609C8E, index=712, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[3]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xDEE1957F, index=779, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[4]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xEB4C2597, index=814, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[6]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xF3FD8CE6, index=848, request_data_type=DataType.BATTERY_MODULE_RESISTANCE,  name='battery.cells_resist[2]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xF8C0D255, index=864, request_data_type=DataType.BATTERY_MODULE_STATUS,      name='battery.cells[0]'),
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xF99E8CC8, index=866, request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[6]'),
    ...
    ObjectInfo(group=ObjectGroup.BATTERY,         object_id=0xFB796780, index=874, request_data_type=DataType.BATTERY_MODULE_STATISTICS,  name='battery.cells_stat[1]'),
    ...
    ObjectInfo(group=ObjectGroup.WIFI,            object_id=0xBA16A10,  index=40,  request_data_type=DataType.ENUM,                       name='wifi.sockb_protocol',                          description='Network mode of the unit: 0 = standalone, 1 = master unit, 2 = slave unit'),
    ...
    ObjectInfo(group=ObjectGroup.WIFI,            object_id=0x6D7C0BF4, index=384, request_data_type=DataType.INT32,                      name='wifi.sockb_port',                              description='Port, either the client port or the master\'s port if unit is a slave'),
    ...
    ObjectInfo(group=ObjectGroup.WIFI,            object_id=0x7DDE352B, index=453, request_data_type=DataType.STRING,                     name='wifi.sockb_ip',                                description="IP of master unit if unit is a slave, else empty"),
    ...
    ObjectInfo(group=ObjectGroup.PRIM_SM,         object_id=0x5F33284E, index=330, request_data_type=DataType.ENUM,                       name='prim_sm.state',                                description='Inverter status',
               enum_map={0: 'Standby', 1: 'Initialization', 2: 'Standby', 3: 'Efficiency (debug state)', 4: 'Insulation check', 5: 'Island check (decide if grid or island mode)', 6: 'Power check (check if enough energy is available to start)', 7: 'Symmetry (DC link alignment)', 8: 'Relais test', 9: 'Grid passive (inverter has power from the grid, not synchronized', 10: 'Prepare Bat Passive', 11: 'Battery Passive (inverter not connected to grid, powered by battery)', 12: 'H/W check (start-preparation)', 13: 'Feed in'}),
